...
import { Menu, X, Home, BookOpen, Target, Play } from 'lucide-react'
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="flex items-center space-x-2" aria-label="How2Chess Home">
            <div className="w-8 h-8 bg-primary-600 rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-lg" aria-hidden="true">♛</span>
            </div>
            <span className="text-xl font-bold gradient-text">How2Chess</span>
          </Link>
